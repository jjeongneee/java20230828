...
public class C18regex {
    public static void main(String[] args) {
        ...
        System.out.println("doooooog".matches("do{1,}g")); // true
        System.out.println("dooooooooooog".matches("do{1,}g")); // true
        ...
        System.out.println("dgg".matches("d[a-z]g")); // true
        ...
        // 이메일 패턴
        // 영문소문자숫자가 여러개 @ 영문소문자, 숫자 여러개 . 영문소문자, 숫자 여러개
        // john23@google3.co2m
        String pat1 = "[a-z0-9]+@[a-z0-9]+\\.[a-z0-9]+";
        System.out.println("john23@google3.co2m".matches(pat1));
        System.out.println("gardening0530@gmail.com".matches(pat1));

        // or : | (pipe)
        System.out.println("auliullndogwer".matches(".*dog.*"));
        System.out.println("832catlkd".matches(".*cat.*"));
        System.out.println("auliullndogwer".matches(".*(dog|cat).*"));
